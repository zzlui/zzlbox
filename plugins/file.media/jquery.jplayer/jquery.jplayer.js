...
*/
		...
		format: { // Static Object
			...
			mp4: { // H.264 / MP4
				codec: 'video/mp4; codecs="mp4v.20.8"',
				flashCanPlay: true,
				media: 'video'
			},
			m4v: { // H.264 / MP4
		...
		_setSize: function() {
			...
			if(this.options.fullScreen) {
                ...
                // --> ZZLBox fix fullscreen
                if(this.htmlElement.video.requestFullScreen) {
                    this.htmlElement.video.requestFullScreen();
                } else if (this.htmlElement.video.mozRequestFullScreen) {
                    this.htmlElement.video.mozRequestFullScreen();
                } else if (this.htmlElement.video.webkitRequestFullScreen) {
                    this.htmlElement.video.webkitRequestFullScreen();
                }
                // TODO fullScreen for flash player
                // <-- end ZZLBox fix
            } else {
